...
LHC Run 2 continued through the quarter, with the Fermilab facility accepting over a petabyte of LHC collision data so far.  As the run continues in earnest, utilization of the Tier 1 has also increased from shutdown levels, with the Fermilab facility being full to capacity becoming the norm rather than the exception.  Site readiness improved over the previous quarter, with Fermilab passing CMS site tests 98% of the time for the quarter as shown in Figure \ref{sc:f1}.  
