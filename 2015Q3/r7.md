...
LHC Run 2 data taking continued through the quarter. The Fermilab facility receiving over a petabyte of LHC collision data so far. Utilization of the Tier-1 has increased from shutdown levels, with the Fermilab facility being full to capacity becoming the norm rather than the exception.  Site readiness improved over the previous quarter, with Fermilab passing CMS site tests 98% of the time for the quarter as shown in Figure \ref{sc:f1}.  
