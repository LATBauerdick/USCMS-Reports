...
\begin{table}[hbtp]
  \begin{center}
    ...
    \resizebox{6.25in}{!}{\includegraphics{figures/CY15Q2_Change_Log.pdf}}
...
\begin{table}[hbtp]
  \begin{center}
    ...
    \resizebox{6.25in}{!}{\includegraphics{figures/CY15Q2_Spending_Plan.pdf}}
...
\begin{figure}[hbtp]
  \begin{center}
    \resizebox{4.5in}{!}{\includegraphics{figures/CY15Q2_DOE_Obligations.pdf}}
...
\begin{figure}[hbtp]
  \begin{center}
    \resizebox{4.5in}{!}{\includegraphics{figures/CY15Q2_NSF_Obligations.pdf}}
...
\begin{figure}[hbtp]
  \begin{center}
    \resizebox{4.5in}{!}{\includegraphics{figures/CY15Q2_TA_DetOps.pdf}}
    \resizebox{4.5in}{!}{\includegraphics{figures/CY15Q2_TA_ComOps.pdf}}
    \resizebox{4.5in}{!}{\includegraphics{figures/CY15Q2_TA_S&C.pdf}}
