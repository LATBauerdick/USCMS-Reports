...
In addition the Level-1 calorimeter trigger upgrade has been commissioned leading to significant improvements in the ECAL Level-1 trigger performance. The trigger is now better able to see the granularity of the 5x5 trigger primitive via the use of dynamic clustering within the 5x5. Figure \ref{fig:ECAL_RES} shows the improvement in the energy and position resolution that results. This leads to higher efficiency in the trigger.
