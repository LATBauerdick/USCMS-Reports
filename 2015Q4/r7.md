...
![Wall clock time consumption of CMS workflows at the U.S. CMS Tier-2 sites by month.][image-1]{#fig:T2} 
...
![Production summary for the last 13 months. A steep increase of the production rate in the first quarter of FY2016 is due to redoing the MINIAOD, the data re-reconstruction, and the MC re-processing with version 76x.][image-2]{#fig:ops}
