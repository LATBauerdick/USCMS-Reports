...
Date          Milestone
------------  -----------------------------------------------------------------
February 1    ROOT and C++ modules: reduce startup memory use by around 20% (achieved)

February 1    Visualization: Implement and support Muon and Barrel Calorimeter TDRs

February 13   All Tier-2 sites upgraded to XrootD 4.6.x

February 28   Full copy of MINIAOD samples placed in U.S.

March 1       USCMS regional xrootd redirector and FNAL local redirector upgraded to v. 4.8

March 1       Core framework: allow concurrent Luminosity Block transitions

March 1       ROOT: Integrate clad, automatic differentiation library that should speed up roofit- and tmva-related computations

March 1       Visualization: Implement and support MIP Timing detector Technical Proposal

March 8       Fermilab T1 CPU fully converted to SL7 + Singularity

March 31      Machine learning R&D: Define and evaluate performance metrics for benchmarks

March 31      Geometry/DD4HEP: Proof of principle example

March 31      Tier0 migrated from CERN AI to HTCondor
------------  -----------------------------------------------------------------
