...
December 2016      Completion of the roll-out of connections the Tier-2 sites to
                   LHCONE VPN by ESNet.
December 2016      For at least 3 sites, implement load-balanced GridFTP servers via DNS
                   or IP as a prelude to decommissioning bestman2.
...
Fermilab Tier-1 computing center passed the metric during xx% of this quarter.](figures/image00.png){#fig:sc1}

Figure {@fig:sc1} shows the site readiness metrics for the Tier 1 during the
quarter. After the heavy ion run completed in December, FNAL upgraded
...
The FNAL LPC computing resources continued to be well utilized.  By the
