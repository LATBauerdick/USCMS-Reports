...
In Table @tab:HBUpgradeMilestones, all the needed HB upgrade electronics are abbreviated "HBE".
...
Event Upset probability.
  ...
  : HB Upgrade Milestones {#tab:HBUpgradeMilestones}
...
The ALCT LX100 boards began large-scale production in February. After
...
(766 kHS), and process more jobs than all Tier-1s combined. The
...
The preparation for Run 3 has started with reshuffling of the older
