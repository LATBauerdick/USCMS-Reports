...
The migration to the DD4HEP framework to describe and use the CMS detector geometry from various places in CMSSW progreses well, achieving the milestone of migration of the DDCore application.
