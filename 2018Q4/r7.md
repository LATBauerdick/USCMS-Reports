...
Date                 Milestone
--------------- --------------------------------------------------------
15 Oct 2018     Produced functional, non-HA, installation of Rucio on CERN hardware.

6 Nov 2018      IBM TS4500 tape library system fully in production at FNAL.

15 Nov 2018     Produced DAS capable of integrating Rucio data.

3 Dec 2018      Successful transition of LPC user metadata handling to new FERRY service.

10 Dec 2018     Setup multiple Oracle DBs at CERN for Rucio.

10 Dec 2018     Detector Geometry: Migrate DD Core application to DD4HEP.

11 Dec 2018     CMSWeb migrated to CRIC from SiteDB.

31 Dec 2018     All agreed milestones and upgrades at 5 of the 7 Tier-2 sites were completed. Remaining sites either have a plan to complete in January 2019 or are held up by campus networking providers.

31 Dec 2018     Analysis uses functional programming based on underlying optimized community array library awkward-array. Filter tracking mkFit into.

31 Dec 2018     Frontier: upgraded to frontier-squid-4 and developed and deployed outage monitoring for the Web Proxy Auto Discover.
...
Issues with EOS/Unified at CERN required manual intervention for a
...
In the XRootd/XCache project, per directory access/usage statistics
